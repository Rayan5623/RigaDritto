    ...
    <div>
      ...
      <div className="max-w-md mx-auto px-4 py-4 flex flex-col gap-4">
        <ZoneCard
          ...
          vuoto={inbox.length === 0 ? "vuota. tocca + per catturare qualcosa." : null}
        >
        ...
        <ZoneCard
          ...
          vuoto={oggi.length === 0 ? "scegli le priorità di oggi dall'inbox." : null}
        >
          {oggi.map((t, i) => (
            <TesseraCard key={t.id} tessera={t} numero={i + 1} />
          ))}
        </ZoneCard>
